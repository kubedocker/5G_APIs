...
* <a href="https://forge.etsi.org/swagger/tools/ApiParserExt.html" target="_blank">API Parser</a> to parse OpenAPI files with APIDevTools Swagger Parser/Validator
